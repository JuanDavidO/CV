...
\begin{tabular}{ll}
Programming Languages: & C++ (2.5 years), C (1.5 years), Python (1.5 years). \\ %, R, Matlab (6 months). \\

Basic Knowledge: & GitHub, {\fb \LaTeX}, \textsc{UNIX}.\\

Operating Systems: & Ubuntu, Windows. %is this really necessary? windows is a given... Linux might not...
...
\color{black}
Analytical, intuitive insight with data, resourceful, diplomatic, adaptable, eager to learn. %good comunicator, creative, multidisciplinariety, horizontal thinking, breadth, I like to solve problems
